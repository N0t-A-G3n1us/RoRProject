...
RSpec.describe GamersController, type: :controller do
  ...
  let(:valid_attributes) { { username:  "Exaadsmple User",
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: gamer.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Gamer" do
        expect {
          post :create, params: {gamer: valid_attributes}, session: valid_session
